...
interface CoinGeckoAssetMarketData {
  id: string
  symbol: string
  name: string
  image: string
...
interface CoinGeckoCategoryMarketData {
  id: string
  name: string
  market_cap: number
  content: string | null
...
interface CoinGeckoSearchData {
  coins: CoinGeckoSearchCoinData[]
}

interface CoinGeckoSearchCoinData {
  id: string
  name: string
  symbol: string
  market_cap_rank: number
...
interface CoinGeckoListedAsset {
  id: string
  symbol: string
  name: string
}
